  ...
  updateReservations = () => {
    ...
    if (!user) {
      ...
      getReservations(user._id)
        .then((res) => {
          this.setState({ reservations: res.reverse() }, () =>
  ...
  paginateReservations = () => {
          ...
          <Row style={{ width: "75%" }} key={number}>
            <Col>
              <Card style={{ padding: 10, marginTop: 10 }}>
                ...
                <Row>
                  <Col>
                    Payment Method : <b>{reservation.paymentMethod}</b>
                  </Col>
                </Row>
                <Row>
                  <br />
                  ...
                  <Col align="right">
                    {/* <b>Total :</b> {reservation.total.toFixed(2)} */}
                  </Col>
                </Row>
                <Row>
                  <Col style={{ paddingTop: 10 }} align="right">
                    <Button
                      ...
                      variant="danger"
                      size="sm"
                      onClick={() => this.cancelReservation(reservation._id)}
                    >
                      Cancel
                    </Button>
                  </Col>
    ...
    for (let number = 1; number <= lastPage; number++) {
      paginateItems.push(
        <Pagination.Item
          key={number}
          active={number === this.state.offset}
